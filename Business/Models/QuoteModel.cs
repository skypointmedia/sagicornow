    ...
    public class QuoteModel
    {
        ...
        public static List<SmokerStatus> SmokerStatuses()
        {
            return new List<SmokerStatus>() {
                ...
                new SmokerStatus() { Text = "No (not in the last 24 months)", Value = "OLI_TOBACCO_NEVER" , tc = "1"},
                //new SmokerStatus() { Text = "Prior", Value = "OLI_TOBACCO_PRIOR" },
                new SmokerStatus() { Text = "Yes (in the last 24 months)", Value = "OLI_TOBACCO_CURRENT", tc = "3" }
            };
        }
